...
class HamClickbaitGenerator
  INDIVIDUALS = ['Old Man Ham', 'M3', 'M6', 'G0', 'G1', 'G2', 'G3', 'G4', 'G5', 'G6', 'G7', 'G8', 'M0', 'M1', 'M5', '2E0', '2E1', 'Maritime Mobile Operator', 'Master of a Vessel', 'A person authorised by Ofcom', 'Unattended Beacon', 'Radio Club', 'Special Event Operator', 'New Licensee', 'Overseas Ham', 'Foundation Licence Holder', 'Intermediate Licence Holder', 'Full Licence Holder', 'Young Ham', 'Female Operator']
  ...
  TEMPLATES = ['{{quantity}} things {{group}} do to avoid {{event}}!', '{{quantity}} {{group}} that haven\'t aged well.', 'This {{individual}} took part in {{event}}. What happened next will amaze you!', 'Watch this {{individual}} {{activity}}. First you\'ll be shocked, then you\'ll be inspired.', 'He worked {{event}} and {{quantity}} {{group}} made it {{event}}.']
